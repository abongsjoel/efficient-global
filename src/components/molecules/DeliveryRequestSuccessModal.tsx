...
type DeliveryRequestSuccessModalProps = {
  isOpen: boolean;
  name: string;
  onGoHome: () => void;
  onClose: () => void;
...
const DeliveryRequestSuccessModal = ({
  isOpen,
  name,
  onGoHome,
  onClose,
  onSubmitAnotherRequest,
}: DeliveryRequestSuccessModalProps) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    <div
      aria-labelledby="delivery-request-success-title"
      aria-modal="true"
...
export default DeliveryRequestSuccessModal;
